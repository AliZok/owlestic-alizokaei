  ...
  return (
    <div className="gap-4 grid lg:grid-cols-2 xl:grid-cols-4 mb-4 text-gray-600">
      <Card>
        ...
        <CardContent>
          <div className="text-lg lg:text-2xl" dir="rtl">
            <span className="text-sky-600 farsi">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-sky-700 text-lg lg:text-2xl">{totalOrders}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-emerald-500 text-lg lg:text-2xl">{deliveredOrders}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-pink-700 text-lg lg:text-2xl">{cancelledOrders}</div>
